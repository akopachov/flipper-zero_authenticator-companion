<script lang="ts">
  ...
  import { importFrom2FasAuth } from '$lib/import';
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      if (file) {
        try {
          ...
          parsedTokens.push(...importFrom2FasAuth(jsonContent));
        } catch (e) {
          errorsFound = true;
          log.error(e);
...
<div class="p-4">
  <h4 class="h4">Import from 2FAS Authenticator</h4>
  <div class="mt-5 mb-5">
    <ol class="list-decimal ml-4">
      <li>Open 2FAS Authenticator app on your phone</li>
      <li>Select "Settings" in the bottom menu</li>
      <li>Select "2FAS Backup"</li>
      <li>Select "Export to file"</li>
      <li><strong>Check\select "Export file without password" toggle</strong></li>
      <li>
        Click "Share" or "Export" button and <strong>
          transfer the exported 2FAS file to this machine in the safest way possible
        </strong>
      </li>
      <li>Drag & drop or select the exported 2FAS file in the area below</li>
    </ol>
  </div>
