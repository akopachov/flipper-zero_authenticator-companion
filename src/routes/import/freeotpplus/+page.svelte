<script lang="ts">
  ...
  import { importFromFreeOtpPlusAuth } from '$lib/import';
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      if (file) {
        try {
          ...
          parsedTokens.push(...importFromFreeOtpPlusAuth(jsonContent));
        } catch (e) {
          errorsFound = true;
          log.error(e);
...
<div class="p-4">
  <h4 class="h4">Import from FreeOTP+ Authenticator</h4>
  <div class="mt-5 mb-5">
    <ol class="list-decimal ml-4">
      <li>Open FreeOTP+ Authenticator app on your phone</li>
      <li>Tap the three-dots menu icon located on the top right corner</li>
      <li>Select "Export"</li>
      <li>Select "Export JSON format"</li>
      <li>
